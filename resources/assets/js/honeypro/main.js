...
// var changeQuant = quantity[0];
//
// changeQuant.oninput = function() {
// 	document.getElementById('quantity_result').innerHTML = '2131';//changeQuant.value;
// };

// $( "input[type='number']" ).change(function() {
//
// 	// str += $( this ).val() + " ";
// 	// $( "#quantity_result" ).val( str );
// 	var inputNumber = parseInt($("input[name='quantity']").val());
...
// 	}
// 	//alert(inputNumber);
// 	//document.getElementById('quantity_result').innerHTML = '123414';
// });

// var $output = $(".honey_change");
// $(".honey_change").keyup(function() {
